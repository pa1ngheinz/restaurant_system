    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('order.index') }}" class="brand-link">
                <p class="brand-text font-weight-light" style="text-align: center; font-size: 30px; margin: 0">
                    Restaurant
                </p>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info d-flex">
                        <img src="{{ Auth::user()->image ? asset('images/profile/' . Auth::user()->image) : asset('images/profile/default.png') }}"
        ...
        <footer class="main-footer">
            ...
            <strong style="color: grey">Pa1ng Hein Kyaw &copy; 2026
            </strong>
        </footer>
    </div>
    <!-- ./wrapper -->
